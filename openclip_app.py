...
from database import setup_database, get_settings, save_project, load_projects, delete_project
...
from ui import home_page, projects_list_page, settings_page
from ui.create_project_page import show as create_project_page  # Corrected import
from ui import project_details_page # Corrected import was here
...
def sidebar_navigation():
    with st.sidebar:
        ...
        st.divider()
        st.info(
            "Need Help? [Check the documentation](https://github.com/openclip-pro/documentation)", icon="❓"
        )
        st.markdown("---")
